...
const OAK_RESERVE_VARIANTS: Variant[] = [
  ...
  { variantId: "75cl",  label: "75cl Bottle",        detail: "75cl · 12% ABV · Limited Edition", price: 85,  image: "/products/oak-reserve.png", outOfStock: true },
  { variantId: "case6", label: "Case of 6 · 6×75cl", detail: "6 × 75cl · Save 10%",               price: 459, originalPrice: 510, badge: "Best value", outOfStock: true /* no case shot yet - UK site reuses the Red Reserve image which is wrong for white Chardonnay; falls back to 75cl until we generate / source a real Oak Reserve case PNG */ },
];
            ...
            >
              ...
              <div className="absolute bottom-2 md:bottom-[40px] right-0 z-10">
                <QuickAddButton
                  ...
                  variantIdx={variantIdx}
                  image={activeVariant.image ?? "/products/oak-reserve.png"}
                  outOfStock
                />
              </div>
            </div>
        ...
        <FadeUp delay={0.2}>
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <QuickAddButton
              ...
              variant={variant}
              variantIdx={variantIdx}
              image={variant.image ?? "/products/oak-reserve.png"}
...
export default function OakReservePage() {
  ...
  const [variantIdx, setVariantIdx] = useState(() =>
    initialVariantIdxFromHash(OAK_RESERVE_VARIANTS),
  );
  const activeVariant = OAK_RESERVE_VARIANTS[variantIdx];
  ...
  return (
    <main className="bg-[#010101] pb-[80px] md:pb-0">
      ...
      <StickyMobileCTA
        productName="Oak Reserve"
        thumbnailSrc={activeVariant.image ?? "/products/oak-reserve.png"}
        slug="oak-reserve"
        vintage={"Late-Disgorged"}
        variant={activeVariant}
        variantIdx={variantIdx}

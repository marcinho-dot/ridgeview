...
// Sparkling Red Reserve variants - synced 2026-05-12 with ridgeview.co.uk.
// Limited Release NV, 100% Pinot Noir. Case of 6 sold separately
// in cases-of-wine category (£330 list / £297 with 10% off, RA412).
// Single-bottle SKU code is R2319.
// Order convention (final, locked 2026-05-12):
//   Position 1: 75cl Bottle (ALWAYS - drives H1 price + default)
//   Position 2: Magnum (if available) [N/A]
//   Position 3: Case of 6 (if available - "Best value" badge)
const SPARKLING_RED_VARIANTS: Variant[] = [
  { variantId: "75cl",  label: "75cl Bottle",        detail: "75cl · 12% ABV · Limited Release", price: 55,  image: "/products/sparkling-red-reserve.png" },
  { variantId: "case6", label: "Case of 6 · 6×75cl", detail: "6 × 75cl · Save 10%",              price: 297, originalPrice: 330, badge: "Best value", image: "/products/sparkling-red-reserve-case.png" },
];
...
function ProductHero({
  ...
  const heroBottleSrc = activeVariant.image ?? "/products/sparkling-red-reserve.png";
  const heroBottleAlt = `Ridgeview Sparkling Red Reserve - Limited Release 100% Pinot Noir sparkling red, ${activeVariant.label}`;
      ...
      <div className="relative max-w-[1600px] mx-auto px-4 md:px-8">
        ...
        <FadeUp>
          <p className="font-body text-white/35 text-[10px] uppercase tracking-[0.3em] mb-4 md:mb-6">
            ...
            <span className="mx-3 text-white/20">/</span>
            <span className="text-white/55">Sparkling Red Reserve</span>
          </p>
        </FadeUp>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[58fr_42fr] gap-3 md:gap-12 items-start">
          ...
          <div className="order-2 md:order-1 flex flex-col md:block">
            <FadeUp className="order-1">
              ...
              >
                [ Limited Release · 100% Pinot Noir ]
              </p>
            </FadeUp>
            ...
            <FadeUp delay={0.3} className="order-3">
              ...
              >
                A pioneering English sparkling red
              </p>
            </FadeUp>
            ...
            <FadeUp delay={0.45} className="order-7">
              ...
              >
                A pioneering, punchy sparkling red from our Head Winemaker&rsquo;s
                portfolio of esoteric creations. Highly aromatic with wild
            ...
            <FadeUp delay={0.55} className="order-5 mb-6 md:mb-0">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-10">
                ...
                <div className="hidden md:flex items-start gap-6 pt-1" aria-label="Awards">
                  {/* WineGB Pioneer Trophy · 2023 */}
                  <div className="flex flex-col items-center gap-2.5">
                    <motion.img
                      src={`${basePath}/images/awards/winegb-2023-trophy.webp`}
                      alt="Pioneer Trophy - WineGB Awards 2023"
                      title="WineGB · Pioneer Trophy 2023"
            ...
            >
              ...
              >
                {/* Bottle keyed on heroBottleSrc → AnimatePresence crossfades
                    ...
                    No case shot for Sparkling Red Reserve yet - Case variant
                    falls back to the 75cl bottle, no visible swap. */}
              ...
              <div className="absolute bottom-2 md:bottom-[40px] right-0 z-10">
                <QuickAddButton
                  ...
                  variantIdx={variantIdx}
                  image={activeVariant.image ?? "/products/sparkling-red-reserve.png"}
                />
              </div>
            </div>
          </FadeUp>
...
function TastingPairingSection() {
  const tastingNotes = ["Wild Blackberry & Cherry", "Pomegranate & Sweet Spice", "Silky Tannin"];
  const foodPairings = [
    "Roast Duck with Cherry Jus",
    "Roasted Celeriac & Sage",
    "English Blue Cheese",
    "Charcuterie Board",
...
// ── Varietal (100% Pinot Noir sparkling red) ──────────────────────────────
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 md:px-8 py-24 md:py-32">
        <div className="text-center mb-12 md:mb-16">
          ...
          <FadeUp delay={0.08}>
            ...
            >
              One grape, <span className="text-[#C8A96E]">no rules</span>.
            </h2>
          </FadeUp>
          <FadeUp delay={0.16}>
            <p
            ...
            >
              Pure Pinot Noir, made sparkling and red. A limited-release
              love-letter to England&rsquo;s finest red grape.
            </p>
          </FadeUp>
        </div>
        ...
        <div className="flex flex-col items-center gap-6 md:gap-8 mb-20 md:mb-24">
          {[
            { grape: "Pinot Noir",     role: "Structure, fruit & spice - 100%" },
          ].map((g, i) => (
        ...
        <FadeUp delay={0.7}>
          <div className="max-w-[920px] mx-auto text-center">
            ...
            >
              ...
              red made to date. A small batch from our Head Winemaker&rsquo;s
              portfolio of esoteric creations, released only in tiny
...
function AwardsSpecsSection() {
  const awards = [
    { medal: "Pioneer Trophy", body: "WineGB Awards", year: "2023" },
  ];

  const specs = [
    { label: "Vintage", value: "Non Vintage · Limited Release" },
    { label: "Grape", value: "100% Pinot Noir" },
    { label: "Style", value: "Sparkling Red · Méthode Traditionnelle" },
    { label: "Bottle Size", value: "75cl" },
    { label: "ABV", value: "12%" },
    { label: "Allergens", value: "Contains Sulphites" },
    { label: "Suitable for", value: "Vegans & Vegetarians" },
    { label: "Product Code", value: "R2319" },
  ];
    ...
    <section className="bg-[#010101] border-t border-white/[0.06]">
      <div className="max-w-[960px] mx-auto px-6 md:px-16 py-20 md:py-28 text-center">
        ...
        <FadeUp delay={0.1}>
          ...
          >
            A red worth <span className="text-[#C8A96E]">breaking the rules</span>.
          </h2>
        </FadeUp>
        <FadeUp delay={0.2}>
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <QuickAddButton
              ...
              variant={variant}
              variantIdx={variantIdx}
              image={variant.image ?? "/products/sparkling-red-reserve.png"}
...
const SCHEMA_LD = {
  ...
  "@type": "Product",
  name: "Ridgeview Sparkling Red Reserve",
  description:
    "Limited Release English Sparkling Red Wine. 100% Pinot Noir vinified red with extended skin contact - wild blackberry, vanilla, cherry and pomegranate over silky tannin and warm spice. Pioneer Trophy at the WineGB Awards 2023.",
  image: "https://ridgeview.vercel.app/products/sparkling-red-reserve.png",
  brand: { "@type": "Brand", name: "Ridgeview Wine Estate" },
  sku: "R2319",
  category: "English Sparkling Red Wine",
  offers: {
    "@type": "AggregateOffer",
    priceCurrency: "GBP",
    lowPrice: "55.00",
    ...
    url: "https://ridgeview.vercel.app/wine/sparkling-red-reserve/",
  },
  aggregateRating: {
  ...
  award: [
    "Pioneer Trophy - WineGB Awards 2023",
  ],
};
...
const FAQ_ITEMS = [
  ...
  {
    question: "How should I store Sparkling Red Reserve?",
    answer:
      "Lay bottles flat in a cool, dark place between 8-12°C. As a sparkling red made for early drinking, enjoy within 2-3 years of release to preserve the wild blackberry and cherry fruit. Serve at 10-14°C - cooler than a still red but warmer than a white sparkling, to bring out the silky tannin and spice.",
  },
  {
...
const RELATED_WINES = [
  ...
  },
  {
    ...
    note: "The middle path - Pinot fruit drawn into a peach-gold rosé.",
  },
  {
    slug: "cavendish",
    name: "Cavendish NV",
  ...
  return (
    <main className="bg-[#010101] pb-[80px] md:pb-0">
      ...
      <ScrollReset>
        <AwardSection
          data={{
            medal: "Pioneer Trophy",
            body: "WineGB Awards",
            year: 2023,
            tier: "Category Winner",
            badgeSrc: "/images/awards/winegb-2023-trophy.webp",
            description: "Awarded the Pioneer Trophy at the WineGB Awards 2023 - the national category recognising the most convincing English sparkling red made to date. A rare and remarkable expression of 100% Pinot Noir vinified red.",
          }}
        />
      </ScrollReset>
      ...
      <StickyMobileCTA
        productName="Sparkling Red Reserve"
        thumbnailSrc={activeVariant.image ?? "/products/sparkling-red-reserve.png"}
        slug="sparkling-red-reserve"
        vintage={"Multi-Vintage Blend"}
        variant={activeVariant}
        variantIdx={variantIdx}

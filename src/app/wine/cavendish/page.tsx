...
const CAVENDISH_VARIANTS: Variant[] = [
  { variantId: "75cl",  label: "75cl Bottle",        detail: "75cl · 12% ABV · NV", price: 36,    image: "/products/cavendish.png" },
  { variantId: "case6", label: "Case of 6 · 6×75cl", detail: "6 × 75cl · Save 10%", price: 194.4, originalPrice: 216, badge: "Best value", image: "/products/cavendish-case.png" },
];
...
function ProductHero({
  ...
  const heroBottleSrc = activeVariant.image ?? "/products/cavendish.png";
  const heroBottleAlt = `Ridgeview Cavendish - Méthode Traditionnelle blend, ${activeVariant.label}`;
            ...
            >
              ...
              <div className="absolute bottom-2 md:bottom-[40px] right-0 z-10">
                <QuickAddButton
                  ...
                  variantIdx={variantIdx}
                  image={activeVariant.image ?? "/products/cavendish.png"}
                />
              </div>
            </div>
          </FadeUp>
        ...
        <FadeUp delay={0.7}>
          <div className="max-w-[920px] mx-auto text-center">
            ...
            >
              ...
              beneath northern France. Pinot Noir and Pinot Meunier carry
        ...
        <FadeUp delay={0.2}>
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <QuickAddButton
              ...
              variant={variant}
              variantIdx={variantIdx}
              image={variant.image ?? "/products/cavendish.png"}
    ...
    <main className="bg-[#010101] pb-[80px] md:pb-0">
      ...
      <ScrollReset>
        <BehindTheBottleSection
          ...
          techSheetPdf="/pdfs/tech-sheets/cavendish-nv.pdf"
        />
      </ScrollReset>
      ...
      <ScrollReset>
        <AwardSection
          data={{
            ...
            description: "Awarded Silver by the global Decanter judging panel - confirming Cavendish as a benchmark for English Méthode Traditionnelle. Also named the UK Government's most-poured sparkling wine in 2024.",
          }}
        />
      </ScrollReset>
      ...
      <StickyMobileCTA
        productName="Cavendish"
        thumbnailSrc={activeVariant.image ?? "/products/cavendish.png"}
        slug="cavendish"
        vintage={"NV"}
        variant={activeVariant}
        variantIdx={variantIdx}

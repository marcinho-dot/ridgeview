...
// Fitzrovia Rosé bottle variants — synced 2026-05-12 with ridgeview.co.uk.
// Case of 6 sold as a separate product listing in the "cases-of-wine"
// category at £216.00 (10% off £240). No Magnum format on the live shop.
...
const FITZROVIA_VARIANTS: Variant[] = [
  { label: "75cl Bottle", detail: "75cl · 12% ABV · NV", price: 40 },
  { label: "Case of 6 · 6×75cl", detail: "6 × 75cl · Save 10%", price: 216, badge: "Best value" },
];
      ...
      <div className="relative max-w-[1600px] mx-auto px-4 md:px-8">
        ...
        <FadeUp>
          <p className="font-body text-white/35 text-[10px] uppercase tracking-[0.3em] mb-4 md:mb-6">
            ...
            <span className="mx-3 text-white/20">/</span>
            <span className="text-white/55">Fitzrovia Rosé</span>
          </p>
        </FadeUp>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[58fr_42fr] gap-3 md:gap-12 items-start">
          ...
          <div className="order-2 md:order-1 flex flex-col md:block">
            ...
            <div className="overflow-hidden mb-2 md:mb-5 order-2">
              ...
              >
                <span className="text-[#C8A96E]">Fitzrovia Rosé</span>
              </motion.h1>
            </div>
                ...
                <div className="hidden md:flex items-start gap-6 pt-1" aria-label="Awards">
                  ...
                  <div className="flex flex-col items-center justify-center gap-2.5 h-[clamp(86px,7.5vw,108px)] px-4 border border-[#C8A96E]/35 rounded-md backdrop-blur-md bg-[#C8A96E]/[0.04]">
                    ...
                    <p className="font-body text-white/55 text-[9px] uppercase tracking-[0.22em] whitespace-nowrap">
                      Harpers <span className="text-[#C8A96E]/70 mx-1">·</span> 2021
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="md:hidden absolute left-0 top-[calc(50%-30px)] -translate-y-1/2 flex flex-col gap-4 z-10 pointer-events-none">
                ...
                <div className="flex flex-col items-center justify-center gap-1 h-[clamp(60px,16vw,80px)] px-2.5 border border-[#C8A96E]/35 rounded-md backdrop-blur-md bg-[#C8A96E]/[0.04]">
                  <p className="font-display italic text-cream text-[12px] leading-none tracking-[0.08em]">
                    ★★★★★
                  </p>
              ...
              >
                ...
                <img
                  ...
                  alt="Ridgeview Fitzrovia Rosé — Classic Method sparkling rosé, 75cl bottle"
...
function TastingPairingSection() {
  const tastingNotes = ["Wild Raspberry & Redcurrant", "Sherbet Citrus", "Cream & Summer Fruit"];
  const foodPairings = [
    "Smoked Salmon & Crème Fraîche",
    "Seared Tuna with Pickled Ginger",
    "Lobster Salad",
    "Buttery Blue Cheese",
    "Eton Mess with Wild Strawberry",
  ];
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 md:px-8 py-24 md:py-32">
        <div className="text-center mb-12 md:mb-16">
          ...
          <FadeUp delay={0.08}>
            ...
            >
              Three grapes, <span className="text-[#C8A96E]">a rosé in pink</span>.
            </h2>
          </FadeUp>
          <FadeUp delay={0.16}>
            <p
            ...
            >
              A Classic Method sparkling rosé from the same chalk vineyards
        ...
        <div className="flex flex-col items-center gap-6 md:gap-8 mb-20 md:mb-24">
          {[
            { grape: "Chardonnay",     role: "Lift & brightness" },
            { grape: "Pinot Noir",     role: "Colour & soft fruit" },
            { grape: "Pinot Meunier",  role: "Roundness & charm" },
          ].map((g, i) => (
    ...
    <section className="bg-[#010101] border-t border-white/[0.06]">
      <div className="max-w-[960px] mx-auto px-6 md:px-16 py-20 md:py-28 text-center">
        ...
        <FadeUp delay={0.1}>
          ...
          >
            Sunshine in a <span className="text-[#C8A96E]">glass</span>.
          </h2>
        </FadeUp>
        <FadeUp delay={0.2}>
...
const SCHEMA_LD = {
  ...
  description:
    "Classic Method English sparkling rosé. A delicate cherry-blossom hue, wild raspberry and honeyed redcurrant aromatics, a spring-fresh palate of sherbet and summer fruit balanced by a creamy long finish. Decanter Silver 2018, IWSC Silver 2020, Harpers ★★★★★ 2021.",
  ...
  offers: {
    ...
    url: "https://ridgeview.vercel.app/wine/fitzrovia/",
  },
  aggregateRating: {
  ...
  award: [
    ...
    "Silver — IWSC & IWC 2020",
    "Star Design + 5 Stars — Harpers Wine Star Awards 2021",
  ],
};
...
const FAQ_ITEMS = [
  ...
  {
    question: "How should I store Fitzrovia Rosé?",
    answer:
      "Lay bottles flat in a cool, dark place between 8–12°C. Fitzrovia is non-vintage and built for early drinking — best enjoyed within 1–2 years to preserve its delicate cherry-blossom hue and bright wild-raspberry character. Serve well chilled at 6–8°C.",
  },
  {
...
const RELATED_WINES = [
  ...
  },
  {
    ...
    note: "Pinot-led with red berries and toasted almond — depth over delicacy.",
  },
  {
      ...
      <ScrollReset>
        <AwardSection
          data={{
            ...
            description: "Awarded Silver by the global Decanter judging panel — a benchmark Classic Method sparkling rosé. Fitzrovia has also collected Silver at IWSC & IWC 2020 and a Star Design ★★★★★ from Harpers Wine Star Awards 2021.",
          }}
        />
      </ScrollReset>

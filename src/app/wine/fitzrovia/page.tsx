            ...
            <FadeUp delay={0.55} className="order-5 mb-6 md:mb-0">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-10">
                ...
                <div className="flex-1 max-w-[480px]">
                  <PurchaseWidget
                    techSheetPdf="/pdfs/tech-sheets/fitzrovia-rose.pdf"
                    slug="fitzrovia"
        ...
        <FadeUp delay={0.7}>
          <div className="max-w-[920px] mx-auto text-center">
            ...
            >
              ...
              the same Cretaceous seam that runs beneath northern France.
...
export default function FitzroviaPage() {
  ...
  const [variantIdx, setVariantIdx] = useState(() =>
    initialVariantIdxFromHash(FITZROVIA_VARIANTS),
  );
  const activeVariant = FITZROVIA_VARIANTS[variantIdx];

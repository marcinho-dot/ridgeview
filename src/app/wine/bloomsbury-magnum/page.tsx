...
// Magnum Bloomsbury variants — synced 2026-05-12 with ridgeview.co.uk
// (/product/magnum-bloomsbury/, R2010). Magnum-only listing — the 75cl
// version lives at /wine/bloomsbury/.
const BLOOMSBURY_MAGNUM_VARIANTS: Variant[] = [
  { label: "1.5L Magnum", detail: "150cl · 12% ABV · NV · Cellar size", price: 85 },
];
      ...
      <div className="relative max-w-[1600px] mx-auto px-4 md:px-8">
        ...
        <FadeUp>
          <p className="font-body text-white/35 text-[10px] uppercase tracking-[0.3em] mb-4 md:mb-6">
            ...
            <span className="mx-3 text-white/20">/</span>
            <span className="text-white/55">Magnum Bloomsbury</span>
          </p>
        </FadeUp>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[58fr_42fr] gap-3 md:gap-12 items-start">
          ...
          <div className="order-2 md:order-1 flex flex-col md:block">
            ...
            <div className="overflow-hidden mb-2 md:mb-5 order-2">
              ...
              >
                <span className="text-[#C8A96E]">Magnum Bloomsbury</span>
              </motion.h1>
            </div>
            ...
            <FadeUp delay={0.45} className="order-7">
              ...
              >
                Majestic and celebratory &mdash; an elegant, larger-than-life
                expression of our signature sparkling. Bright citrus and juicy
                white peach on the nose; honey, brioche and a creamy mousse on
                the palate. The magnum format slows the ageing, building the
                minerality and biscuity depth that Sommelier Awards 2024 named
            ...
            <FadeUp delay={0.55} className="order-5 mb-6 md:mb-0">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-10">
                ...
                <div className="flex-1 max-w-[480px]">
                  <PurchaseWidget
                    variants={BLOOMSBURY_MAGNUM_VARIANTS}
                ...
                <div className="hidden md:flex items-start gap-6 pt-1" aria-label="Awards">
                  {/* Sommelier Awards 2024 — Sparkling Wine of the Year.
                    Typographic panel; no medal image exists for Sommelier. */}
                  ...
                  {/* Gold · Sommelier Awards 2024 — typographic */}
                  <div className="flex flex-col items-center justify-center gap-2.5 h-[clamp(86px,7.5vw,108px)] px-4 border border-[#C8A96E]/35 rounded-md backdrop-blur-md bg-[#C8A96E]/[0.04]">
                    <p className="font-display italic text-cream text-[clamp(13px,1.1vw,15px)] leading-none whitespace-nowrap">
                      Gold
                    </p>
                    <p className="font-body text-white/55 text-[9px] uppercase tracking-[0.22em] whitespace-nowrap">
                      Sommelier Awards <span className="text-[#C8A96E]/70 mx-1">·</span> 2024
                    </p>
                  </div>
                </div>
              </div>
          ...
          <FadeUp delay={0.05} className="order-1 md:order-2 md:mt-20">
            ...
            >
              ...
              <div className="md:hidden absolute left-0 top-[calc(50%-30px)] -translate-y-1/2 flex flex-col gap-4 z-10 pointer-events-none">
                {/* Mobile: Sommelier Awards 2024 typographic */}
              ...
              >
                ...
                <img
                  src={`${basePath}/products/bloomsbury-magnum.png`}
                  alt="Ridgeview Magnum Bloomsbury NV — English Sparkling Wine, 1.5L magnum"
...
function TastingPairingSection() {
  const tastingNotes = ["Bright Citrus & White Peach", "Honey & Brioche", "Biscuity Cream"];
  const foodPairings = [
    "Smoked Salmon Canapés",
    "Fish & Chips · Whisper-Thin Batter",
...
function AwardsSpecsSection() {
  ...
  const specs = [
    ...
    { label: "Style", value: "Brut · Classic Method · Magnum Format" },
    { label: "Bottle Size", value: "150cl (Magnum)" },
    { label: "ABV", value: "12%" },
    { label: "Ageing", value: "Slower lees ageing in Magnum format" },
    { label: "Allergens", value: "Contains Sulphites" },
    { label: "Suitable for", value: "Vegans & Vegetarians" },
    { label: "Product Code", value: "R2010" },
  ];
...
const SCHEMA_LD = {
  ...
  "@type": "Product",
  name: "Ridgeview Magnum Bloomsbury",
  description:
    "Majestic 1.5L Magnum format of Ridgeview's signature Bloomsbury NV English Sparkling Wine. Bright citrus and white peach with honey, brioche and biscuity depth from slower magnum-format ageing. Sparkling Wine of the Year & Gold — Sommelier Awards 2024.",
  image: "https://ridgeview.vercel.app/products/bloomsbury-magnum.png",
  ...
  offers: {
    ...
    url: "https://ridgeview.vercel.app/wine/bloomsbury-magnum/",
  },
  aggregateRating: {
...
const FAQ_ITEMS = [
  ...
  {
    question: "How should I store Magnum Bloomsbury?",
    answer:
      "Lay bottles flat in a cool, dark place between 8–12°C. Magnum-format sparkling ages more slowly than 75cl bottles, building richer biscuity depth and finer mousse over time — Magnum Bloomsbury will continue to evolve for 5–8 years from disgorgement. Best served at 6–8°C from a chilled magnum.",
  },
  {
...
const RELATED_WINES = [
  {
    slug: "bloomsbury",
    name: "Bloomsbury NV",
    style: "House Cuvée · 75cl",
    price: 34,
    image: "/products/bloomsbury.png",
    note: "The same Classic Method blend in standard 75cl format — bright and ready to pour.",
  },
  {
    ...
    note: "Pure Chardonnay from the 1995 plantings — vintage depth in 75cl.",
  },
  {
    slug: "cavendish",
    name: "Cavendish NV",
    ...
    note: "Pinot-led everyday blend — red berries, toasted almond, depth over delicacy.",
  },
];

export default function BloomsburyMagnumPage() {
  const testimonial = getTestimonial("magnum-bloomsbury");
  ...
  return (
    <main className="bg-[#010101] pb-[80px] md:pb-0">
      ...
      <ScrollReset>
        <AwardSection
          data={{
            ...
            // No Sommelier-Awards-specific badge image is available;
            // re-using IWSC-Gold-2020 as a generic gold-tier visual
            // (the medal/body/year text accurately credits Sommelier 2024).
            badgeSrc: "/images/awards/iwsc-95pts-2020-gold.webp",
            description: "Crowned Sparkling Wine of the Year at the Sommelier Awards 2024 — a peer-judged recognition that also awarded the wine a Gold medal in the same year. Magnum-format slower ageing carries the depth and biscuity complexity the panel rewarded.",
          }}
        />
      </ScrollReset>
      ...
      <StickyMobileCTA
        productName="Magnum Bloomsbury"
        price="£85.00 · 1.5L"
        thumbnailSrc="/products/bloomsbury-magnum.png"

...
// Still Chardonnay variants - synced 2026-05-12 with ridgeview.co.uk
      ...
      <div className="relative max-w-[1600px] mx-auto px-4 md:px-8">
        ...
        <FadeUp>
          <p className="font-body text-white/35 text-[10px] uppercase tracking-[0.3em] mb-4 md:mb-6">
            ...
            <span className="mx-3 text-white/20">/</span>
            <span className="text-white/55">Still Chardonnay</span>
          </p>
        </FadeUp>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[58fr_42fr] gap-3 md:gap-12 items-start">
          ...
          <div className="order-2 md:order-1 flex flex-col md:block">
            ...
            <div className="overflow-hidden pb-3 md:pb-5 mb-2 md:mb-5 order-2">
              ...
              >
                <span className="text-[#C8A96E]">Still Chardonnay</span>
              </motion.h1>
            </div>
            ...
            <FadeUp delay={0.55} className="order-5 mb-6 md:mb-0">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-10">
                ...
                <div className="flex-1 max-w-[480px]">
                  <PurchaseWidget
                    techSheetPdf="/pdfs/tech-sheets/still-chardonnay.pdf"
                ...
                {/* No hero awards for Still Chardonnay - NEW launch, no
                    accolades yet (no fake badges per badge-honesty rule). */}
              </div>
            </FadeUp>
          </div>
          ...
          <FadeUp delay={0.05} className="order-1 md:order-2 md:mt-20">
            ...
            >
              ...
              {/* No mobile award badges for Still Chardonnay (NEW launch,
                  no accolades yet). Bottle wrapper has no overlay items. */}
              ...
              >
                ...
                <img
                  src={`${basePath}/products/still-chardonnay.png`}
                  alt="Ridgeview Still Chardonnay 2023 - 100% Chardonnay still wine, 75cl bottle"
...
function TastingPairingSection() {
  const tastingNotes = ["White Blossom & Lychee", "Peach, Pear & Apricot", "Silky Mineral Finish"];
  const foodPairings = [
    "Herb-Crusted Cod with Pea Purée",
    "Pork Belly with Creamy Garlic Mash",
    "Courgette & Lemon Risotto",
    "Roast Chicken with Tarragon",
    "Goat Cheese & Stone-Fruit Salad",
  ];
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 md:px-8 py-24 md:py-32">
        <div className="text-center mb-12 md:mb-16">
          ...
          <FadeUp delay={0.08}>
            ...
            >
              One grape, <span className="text-[#C8A96E]">no bubbles</span>.
            </h2>
          </FadeUp>
          <FadeUp delay={0.16}>
            <p
...
function AwardsSpecsSection() {
  ...
  const specs = [
    ...
    { label: "Style", value: "Still · Estate-Grown" },
    ...
    <section className="bg-[#010101] border-t border-white/[0.06]">
      <div className="max-w-[960px] mx-auto px-6 md:px-16 py-20 md:py-28 text-center">
        ...
        <FadeUp delay={0.1}>
          ...
          >
            A still wine, <span className="text-[#C8A96E]">for the table</span>.
          </h2>
        </FadeUp>
        <FadeUp delay={0.2}>
...
const SCHEMA_LD = {
  ...
  "@type": "Product",
  name: "Ridgeview Still Chardonnay 2023",
  description:
    "Ridgeview's first-ever still wine - 100% estate-grown Chardonnay. White blossom and lychee aromatics over a palate of peach, pear and apricot, finishing silky with mineral lift.",
  image: "https://ridgeview.vercel.app/products/still-chardonnay.png",
  ...
  offers: {
    ...
    url: "https://ridgeview.vercel.app/wine/still-chardonnay/",
  },
};
...
const FAQ_ITEMS = [
  ...
  {
    question: "How should I store Still Chardonnay?",
    answer:
      "Store upright (still wines don't need to lie flat - there's no cork to keep wet under pressure) in a cool, dark place between 10-14°C. Best enjoyed within 1-2 years of release to preserve the floral, stone-fruit freshness. Serve chilled at 8-10°C.",
  },
  {
...
const RELATED_WINES = [
  {
    ...
    note: "Same grape, sparkling - pure Chardonnay from the 1995 plantings.",
  },
  {
    slug: "bloomsbury",
    name: "Bloomsbury NV",
    ...
    note: "The Chardonnay-led everyday sparkling blend - bright and ready to pour.",
  },
  {
    slug: "cavendish",
    name: "Cavendish NV",
    ...
    note: "Pinot-led NV blend - red berries and toasted almond.",
  },
];

export default function StillChardonnayPage() {
  // No press testimonial for Still Chardonnay yet (NEW launch).
  // getTestimonial returns undefined → TestimonialSection skipped.
  const testimonial = getTestimonial("still-chardonnay");
  ...
  return (
    <main className="bg-[#010101] pb-[80px] md:pb-0">
      ...
      {/* AwardSection omitted - Still Chardonnay is a new launch with
          no accolades yet. AwardsSpecsSection below renders empty awards
          list + the wine's specs. */}

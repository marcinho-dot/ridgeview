...
const BLANC_DE_NOIRS_VARIANTS: Variant[] = [
  { label: "75cl Bottle", detail: "75cl · 12% ABV · Vintage 2016", price: 60 },
  { label: "Case of 6 · 6×75cl", detail: "6 × 75cl · Save 10%", price: 324, badge: "Best value" },
];
          ...
          <FadeUp delay={0.05} className="order-1 md:order-2 md:mt-20">
            ...
            >
              ...
              >
                ...
                <img
                  src={`${basePath}/products/blanc-de-noirs.png`}
                  alt="Ridgeview Blanc de Noirs 2016 — Vintage Pinot-led sparkling, 75cl bottle"
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 md:px-8 py-24 md:py-32">
        <div className="text-center mb-12 md:mb-16">
          ...
          <FadeUp delay={0.16}>
            ...
            >
              The Pinots, vinified white. A vintage Classic Method
...
const SCHEMA_LD = {
  ...
  description:
    "Vintage 2016 Classic Method English Sparkling Wine made entirely from red grapes (Pinot Noir + Pinot Meunier). White cherry, sweet spice and toasted hazelnut over a structured, mineral-driven finish. WineGB Best Blanc de Noirs 2023.",

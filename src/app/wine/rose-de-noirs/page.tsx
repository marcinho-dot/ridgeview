...
const ROSE_DE_NOIRS_VARIANTS: Variant[] = [
  { variantId: "75cl",  label: "75cl Bottle",        detail: "75cl · 12% ABV · Vintage 2020", price: 65,  image: "/products/rose-de-noirs.png" },
  { variantId: "case6", label: "Case of 6 · 6×75cl", detail: "6 × 75cl · Save 10%",           price: 351, originalPrice: 390, badge: "Best value", image: "/products/rose-de-noirs-case.png" },
];
...
function ProductHero({
  ...
  const heroBottleSrc = activeVariant.image ?? "/products/rose-de-noirs.png";
  const heroBottleAlt = `Ridgeview Rosé de Noirs 2020 - Vintage Pinot-led sparkling rosé, ${activeVariant.label}`;
      ...
      <div className="relative max-w-[1600px] mx-auto px-4 md:px-8">
        ...
        <FadeUp>
          <p className="font-body text-white/35 text-[10px] uppercase tracking-[0.3em] mb-4 md:mb-6">
            ...
            <span className="mx-3 text-white/20">/</span>
            <span className="text-white/55">Rosé de Noirs</span>
          </p>
        </FadeUp>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[58fr_42fr] gap-3 md:gap-12 items-start">
          ...
          <div className="order-2 md:order-1 flex flex-col md:block">
            ...
            <div className="overflow-hidden pb-3 md:pb-5 mb-2 md:mb-5 order-2">
              ...
              >
                <span className="text-[#C8A96E]">Rosé de Noirs</span>
              </motion.h1>
            </div>
            ...
            <FadeUp delay={0.3} className="order-3">
              ...
              >
                A grown-up English sparkling rosé
              </p>
            </FadeUp>
            ...
            <FadeUp delay={0.55} className="order-5 mb-6 md:mb-0">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 md:gap-10">
                ...
                <div className="flex-1 max-w-[480px]">
                  <PurchaseWidget
                    techSheetPdf="/pdfs/tech-sheets/rose-de-noirs-2020.pdf"
                    slug="rose-de-noirs"
            ...
            >
              ...
              <div className="absolute bottom-2 md:bottom-[40px] right-0 z-10">
                <QuickAddButton
                  ...
                  variantIdx={variantIdx}
                  image={activeVariant.image ?? "/products/rose-de-noirs.png"}
                />
              </div>
            </div>
          </FadeUp>
...
function TastingPairingSection() {
  const tastingNotes = ["Wild Strawberry & Cherry", "Honey & Cranberry", "Almond Biscuit"];
  const foodPairings = [
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 md:px-8 py-24 md:py-32">
        <div className="text-center mb-12 md:mb-16">
          ...
          <FadeUp delay={0.08}>
            ...
            >
              Two red grapes, <span className="text-[#C8A96E]">one peach-gold rosé</span>.
            </h2>
          </FadeUp>
          <FadeUp delay={0.16}>
            <p
            ...
            >
              The Pinots, with brief skin contact. A vintage saignée
              rosé from our Sussex chalk vineyards.
            </p>
          </FadeUp>
        </div>
        ...
        <FadeUp delay={0.7}>
          <div className="max-w-[920px] mx-auto text-center">
            ...
            >
              ...
              tier of the global judging panel.
            </p>
          </div>
        </FadeUp>
      </div>
    ...
    <section className="bg-[#010101] border-t border-white/[0.06]">
      <div className="max-w-[960px] mx-auto px-6 md:px-16 py-20 md:py-28 text-center">
        ...
        <FadeUp delay={0.1}>
          ...
          >
            A rosé worth <span className="text-[#C8A96E]">taking seriously</span>.
          </h2>
        </FadeUp>
        <FadeUp delay={0.2}>
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <QuickAddButton
              ...
              variant={variant}
              variantIdx={variantIdx}
              image={variant.image ?? "/products/rose-de-noirs.png"}
...
const SCHEMA_LD = {
  ...
  award: [
    "Platinum (Best in Show) - Decanter World Wine Awards 2023",
  ],
};
...
const FAQ_ITEMS = [
  ...
  {
    question: "How should I store Rosé de Noirs?",
    answer:
      "Lay bottles flat in a cool, dark place between 8-12°C. Vintage rosé sparkling drinks beautifully on release but holds its colour and structure well for 4-6 years from disgorgement. Serve well chilled at 6-8°C to preserve the peach-gold hue and bright red-fruit aromatics.",
  },
  {
...
const RELATED_WINES = [
  {
    slug: "blanc-de-noirs",
    name: "Blanc de Noirs",
    style: "Vintage · Pinot-Led Cuvée",
    price: 60,
    image: "/products/blanc-de-noirs.png",
    note: "Same red grapes - vinified white. The pale-gold sibling to this rosé.",
  },
  {
    slug: "fitzrovia",
    name: "Fitzrovia Rosé",
    ...
    note: "The everyday rosé - fresh, fruit-driven, ready to pour.",
  },
  {
...
export default function RoseDeNoirsPage() {
  ...
  return (
    <main className="bg-[#010101] pb-[80px] md:pb-0">
      ...
      <ScrollReset>
        <AwardSection
          data={{
            ...
            description: "Awarded Platinum (Best in Show) by the global Decanter judging panel - the top tier of recognition, placing Rosé de Noirs among the world's finest sparkling rosés.",
          }}
        />
      </ScrollReset>
      ...
      <StickyMobileCTA
        productName="Rosé de Noirs"
        thumbnailSrc={activeVariant.image ?? "/products/rose-de-noirs.png"}
        slug="rose-de-noirs"
        vintage={"2020"}
        variant={activeVariant}
        variantIdx={variantIdx}

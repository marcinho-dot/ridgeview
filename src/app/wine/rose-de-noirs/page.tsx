          ...
          <FadeUp delay={0.05} className="order-1 md:order-2 md:mt-20">
            ...
            >
              ...
              >
                ...
                <img
                  src={`${basePath}/products/rose-de-noirs.png`}
                  alt="Ridgeview Rosé de Noirs 2020 — Vintage Pinot-led sparkling rosé, 75cl bottle"
...
const SCHEMA_LD = {
  ...
  description:
    "Vintage 2020 Classic Method English sparkling rosé. Peach-gold hue with wild strawberry, cherry and almond-biscuit notes over a soft, creamy finish. Platinum at the Decanter World Wine Awards 2023.",

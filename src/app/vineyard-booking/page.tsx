    ...
    <section className="relative overflow-hidden bg-[#010101] min-h-[68vh] md:min-h-[92vh]">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-16 py-24 md:py-32 min-h-[68vh] md:min-h-[92vh] flex items-center">
        <div className="w-full grid grid-cols-1 md:grid-cols-[5fr_7fr] gap-6 md:gap-16 items-stretch">
          ...
          {/* LEFT: text column. Reading order reverted 2026-05-18 to
              Marc's original sequence:
                Intro → Quote → Attribution → Body → Divider.
              Intro paragraph wraps to two balanced lines via
              text-wrap:balance + a slightly narrower maxWidth so the
              browser can't fit the sentence on a single 503px line. */}
            ...
            <FadeUp delay={0.1}>
              <p
                ...
                style={{
                  ...
                  // evenly across the two lines instead of orphaning
                  // "down." on its own.
                  maxWidth: "460px",
                  textWrap: "balance",
...
function VisitPanels() {
  return (
    <section className="bg-[#010101]">
      ...
      <div className="max-w-[960px] mx-auto px-6 md:px-16 pt-[206px] pb-16 md:pt-[238px] md:pb-20 text-center">
        <FadeUp>
        ...
        <FadeUp delay={0.3}>
          <div className="group relative overflow-hidden flex flex-col justify-end" style={{ minHeight: "70vh" }}>
            <img
              ...
              alt="The Rows & Vine restaurant pavilion at golden hour"
              className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1.4s] ease-out group-hover:scale-[1.03]"
